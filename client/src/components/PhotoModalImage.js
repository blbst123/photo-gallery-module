...
const PhotoModalImage = function (props) {
  ...
  return (
    <div className={css['photo-modal__image']} style={style}>
      <div className={css['arrow-container-left']} onClick={changePhoto.bind(null, image.photoNum, -1)}>
      ...
      <div className={css['arrow-container-right']} onClick={changePhoto.bind(null, image.photoNum, 1)}>
        <svg className={css.arrow}>
