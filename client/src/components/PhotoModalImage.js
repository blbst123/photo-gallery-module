...
const PhotoModalImage = function (props) {
  ...
  image.url = 'https://s3-media3.fl.yelpcdn.com/bphoto/DLnS2yITwrFX8PBJdoVcpg/o.jpg';
  // TODO REMOVE THIS
  ...
  return (
    <div className="photo-modal__image" style={style}>
      ...
      <PhotoModalImageBottomBar imageNum={image.imageNum} totalImagesNum={image.totalImagesNum} />
    </div>
  );
};
